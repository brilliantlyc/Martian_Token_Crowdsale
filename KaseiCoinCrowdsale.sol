...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale { // ADD INHERITANCE TO THE CONTRACT SIGNATURE 
    
    // Provide parameters for all of the features of our crowdsale, such as the `rate`, `wallet` for fundraising, and `token`.
    // Also,  the 'goal' of the crowdsale in ether, 'open' for opening time, and 'close' for closing time.
    constructor(
